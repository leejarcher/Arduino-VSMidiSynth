 ...
 * 
     MODIFIED 5/3/2022 for VSMidiSynth
 *                     Lee J Archer
 */
...
// added 14/03/2022
void Adafruit_VS1053::midiWrite(uint8_t midiByte) {
    ...
    spiwrite(0x00); // send 0x00 to make sure midi byte goes straight
                    // to processing (see rtmidi.pdf VS website)
